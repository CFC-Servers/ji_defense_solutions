            ...
            particle:SetCollideCallback( function( pertical, hitpos, hitnorm )
                ...
                if IsValid( emitter ) then
                    ...
                    if porticel then
                        ...
                        --the particle probably hit the ground instantly as a result of being emitted from the grenade downwards while the grenade was sitting on the ground
                        if lifeleftfraction > 0.9 then
                            porticel:SetStartAlpha( 175 )
                        end
