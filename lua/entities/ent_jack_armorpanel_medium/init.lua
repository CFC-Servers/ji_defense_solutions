...
function ENT:SpawnFunction(ply,tr)
	...
	local ent=ents.Create("ent_jack_armorpanel_medium")
	ent:SetPos(SpawnPos)
...
function ENT:Initialize()
	...
	if not((self.AmHelper)or(self.AmReinforcer))then
		self.Helper=ents.Create("ent_jack_armorpanel_medium")
		...
		--[[
		self.Reinforcer1=ents.Create("ent_jack_armorpanel_medium")
