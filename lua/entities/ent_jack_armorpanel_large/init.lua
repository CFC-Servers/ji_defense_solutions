...
function ENT:SpawnFunction(ply,tr)
	...
	local ent=ents.Create("ent_jack_armorpanel_large")
	ent:SetPos(SpawnPos)
...
function ENT:Initialize()
	...
	if not((self.AmHelper)or(self.AmReinforcer))then
		self.Helper=ents.Create("ent_jack_armorpanel_large")
		...
		--[[
		self.Reinforcer1=ents.Create("ent_jack_armorpanel_large")
